...
namespace MikePhil.Charting.Buffer
{
    public partial class CircleBuffer
    {
        ...
        // Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.buffer']/class[@name='CircleBuffer']/method[@name='feed' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;com.github.mikephil.charting.data.Entry&gt;']]"
